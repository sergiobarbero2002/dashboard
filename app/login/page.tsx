          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="feature-card p-6 bg-white/80 backdrop-blur-xl rounded-2xl border border-amber-200/50 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                ...
                <h3 className="text-xl font-bold text-slate-800 mb-3 text-center">Más Clientes</h3>
                <p className="text-slate-600 text-center leading-relaxed text-sm">Respuestas rápidas y seguimientos convierten a los clientes potenciales en reservas.</p>
              ...
              <div className="feature-card p-6 bg-white/80 backdrop-blur-xl rounded-2xl border border-amber-200/50 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                ...
                <h3 className="text-xl font-bold text-slate-800 mb-3 text-center">Ahorro en Personal</h3>
              ...
              <div className="feature-card p-6 bg-white/80 backdrop-blur-xl rounded-2xl border border-amber-200/50 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                ...
                <p className="text-slate-600 text-center leading-relaxed text-sm">Ofertas upselling personalizadas aumentan el ticket medio por reserva de forma natural.</p>
                <div className="mt-3 flex justify-center">
              ...
              <div className="feature-card p-6 bg-white/80 backdrop-blur-xl rounded-2xl border border-amber-200/50 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                ...
                <h3 className="text-xl font-bold text-slate-800 mb-3 text-center">Más Reseñas</h3>
                <p className="text-slate-600 text-center leading-relaxed text-sm">Atención inmediata y mejor percepción	 que mejora la reputación y genera reseñas positivas de huéspedes.</p>
                <div className="mt-3 flex justify-center">
