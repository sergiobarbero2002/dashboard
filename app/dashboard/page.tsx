        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <KpiCard
              ...
              icon="📧"
              infoContent="Número total de emails procesados por el sistema de IA en el período seleccionado. Incluye todos los emails recibidos, procesados automáticamente y los que requieren intervención manual."
              infoTitle="Total de Emails Procesados"
            />
            ...
            <KpiCard
              ...
              icon="⏱️"
              infoContent="Tiempo promedio que tarda el sistema en responder a los emails. Incluye tanto respuestas automáticas como manuales. Un tiempo menor indica mayor eficiencia del sistema."
              infoTitle="Tiempo Medio de Respuesta"
            />
            ...
            <KpiCard
              ...
              icon="🎯"
              infoContent="Porcentaje de emails que reciben respuesta en menos de 10 minutos. Este es un indicador clave de rendimiento (KPI) que mide la eficiencia del sistema de respuesta automática."
              infoTitle="Cumplimiento SLA <10min"
            />
            ...
            <KpiCard
              ...
              icon="😊"
              infoContent="Puntuación de satisfacción del cliente basada en el análisis de sentimiento de los emails. Se calcula analizando el tono y contenido de las respuestas de los clientes (escala 1-5)."
              infoTitle="Satisfacción del Cliente"
            />
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <KpiCard
              ...
              icon="💰"
              infoContent="Ingresos adicionales generados a través de ofertas de upselling y cross-selling enviadas automáticamente por el sistema de IA. Incluye servicios adicionales, upgrades y productos complementarios."
              infoTitle="Ingresos por Upselling"
            />
            ...
            <KpiCard
              ...
              infoContent="Ahorro económico estimado al automatizar el procesamiento de emails. Se calcula multiplicando el tiempo ahorrado por el coste real de un empleado. Los parámetros son configurables según tu hotel."
              infoTitle="Ahorro en Personal"
              extraContent={
              <button
                onClick={() => {
                  playClick()
            ...
            <KpiCard
              ...
              infoContent="Porcentaje de emails que requieren intervención manual del personal. Un porcentaje menor indica mayor automatización y eficiencia del sistema de IA."
              infoTitle="Intervención Manual"
            />
            ...
            <KpiCard
              ...
              icon="⚠️"
              infoContent="Porcentaje de emails que no han recibido respuesta. Un porcentaje alto puede indicar problemas en el sistema o emails que requieren atención especial."
              infoTitle="Emails Sin Responder"
            />
          </div>
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              <ChartCard
                ...
                infoContent="Análisis automático del sentimiento de los emails de los clientes usando IA. Clasifica las respuestas en 5 categorías para medir la satisfacción general."
                infoTitle="Análisis de Sentimiento"
              >
                <DonutChart
                  data={(() => {
              ...
              <ChartCard
                ...
                infoContent="Distribución de emails por idioma detectado automáticamente. Ayuda a identificar la diversidad lingüística de tus clientes y planificar recursos de atención."
                infoTitle="Idiomas de Comunicación"
              >
                <DonutChart
              ...
              <ChartCard
                ...
                infoContent="Clasificación automática de emails por categoría (reservas, consultas, incidencias, etc.). Ayuda a entender los tipos de consultas más frecuentes de tus clientes."
                infoTitle="Categorías de Emails"
              >
                <DonutChart
          ...
          <div className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">🤖 Volumen y Tiempos de Respuesta </h2>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <ChartCard
                ...
                infoContent="Evolución temporal del volumen de emails mostrando la eficiencia del sistema de IA. La línea verde (Automático) muestra emails procesados sin intervención humana."
                infoTitle="Volumen de Emails"
              >
                <LineChart
              ...
              <ChartCard
                ...
                infoContent="Distribución de emails por tramos de tiempo de respuesta (SLA). Muestra qué porcentaje de emails se responde en cada rango de tiempo."
                infoTitle="Distribución SLA"
              >
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
              <KpiCard
                ...
                infoContent="Número total de ofertas de upselling enviadas automáticamente por el sistema de IA en el período seleccionado."
                infoTitle="Total Ofertas Enviadas"
              />
              ...
              <KpiCard
                ...
                infoContent="Número de ofertas de upselling que fueron aceptadas por los clientes, generando ingresos adicionales."
                infoTitle="Total Ofertas Convertidas"
              />
              ...
              <KpiCard
                ...
                infoContent="Porcentaje promedio de ofertas de upselling que son aceptadas por los clientes. Una tasa alta indica ofertas efectivas."
                infoTitle="Tasa de Conversión Media"
              />
              ...
              <KpiCard
                ...
                infoContent="Porcentaje promedio de emails que incluyen ofertas de upselling. Mide la frecuencia con que el sistema envía ofertas."
                infoTitle="Tasa de Oferta Media"
              />
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <ChartCard
                ...
                infoContent="Evolución de las ofertas de upselling enviadas automáticamente y su tasa de conversión. Muestra la efectividad del sistema de IA para generar ingresos adicionales."
                infoTitle="Ofertas de Upselling"
              >
                <LineChart
              ...
              <ChartCard
                ...
                infoContent="Ganancias estimadas generadas por las ofertas de cross-selling aceptadas. Cada barra representa los ingresos adicionales en el período correspondiente."
                infoTitle="Ganancias Cross-Selling"
              >
                <DynamicBarChart
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
              <KpiCard
                ...
                infoContent="Número total de incidencias reportadas por los clientes en el período seleccionado. Incluye problemas, quejas y solicitudes especiales."
                infoTitle="Total de Incidencias"
              />
              ...
              <KpiCard
                ...
                infoContent="Tiempo promedio que tarda el personal en gestionar una incidencia desde que se reporta hasta que se asigna a un responsable."
                infoTitle="Tiempo Medio de Gestión"
              />
              ...
              <KpiCard
                ...
                infoContent="Tiempo promedio que tarda en resolverse una incidencia desde que se asigna hasta que se cierra completamente."
                infoTitle="Tiempo Medio de Resolución"
              />
              ...
              <KpiCard
                ...
                infoContent="Número de veces que los clientes han hecho clic en enlaces para dejar reseñas después de resolver incidencias."
                infoTitle="Clicks en Reseñas"
              />
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <ChartCard
                ...
                infoContent="Distribución de incidencias por tipo o subcategoría. Ayuda a identificar los problemas más frecuentes y planificar mejoras en el servicio."
                infoTitle="Incidencias por Tipo"
              >
                <DonutChart
              ...
              <ChartCard
                ...
                infoContent="Evolución temporal de incidencias y tiempos de respuesta. Muestra la eficiencia en la gestión y resolución de problemas del hotel."
                infoTitle="Evolución de Incidencias"
              >
                <LineChart
